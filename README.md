...
{
	Lcd_cursor(&lcd,0,1);
	Lcd_string(&lcd,"Magesh\n");

	Lcd_cursor(&lcd,1,1);
	Lcd_string(&lcd,"123456");
}
...
## Output screen shots of proteus  :
 <img width="1920" height="1200" alt="image" src="https://github.com/user-attachments/assets/f0b5294e-394f-4580-bde0-15aa0062bcfc" />

 
 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
 <img width="1313" height="867" alt="image" src="https://github.com/user-attachments/assets/ae6cb69d-0175-4cf1-b068-a815900ad54f" />
